...
public enum CustomExceptionContext implements ExceptionContext {
    ...
    // 인증,인가 관련 예외
    INVALID_TOKEN("유효하지 않은 토큰입니다.", 2001),
    EXPIRED_TOKEN("만료된 토큰입니다.", 2002),
    LOGIN_FAILURE("로그인에 실패했습니다.", 2003),
    NOT_AUTHENTICATION("인증이 필요합니다.",2004),
    NOT_AUTHORIZATION("권한이 필요합니다.",2005),
    BAD_USER_AUTHENTICATION("해당 토큰의 인증 정보가 유효하지 않습니다.", 2006),
